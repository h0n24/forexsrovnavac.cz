<header class="navbar navbar-fixed-top navbar-inverse" id="top" role="banner">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="{{url}}" class="navbar-brand">Forex <i class="fa fa-bar-chart-o"></i> comparar</a>
    </div>
    <nav class="navbar-collapse bs-navbar-collapse collapse" role="navigation" style="height: 1px;" id="scrollpsy">
      <ul class="nav navbar-nav">
        <li>
          <a href="{{url}}plus500#section-2">Negociando</a>
        </li>
        <li>
          <a href="{{url}}plus500#section-3">Como negociar</a>
        </li>
        <li>
          <a href="{{url}}plus500#section-5">Avaliação</a>
        </li>
        <li>
          <a href="{{url}}plus500#section-6">Como chegar</a>
        </li>
        <li>
          <a href="{{url}}plus500#section-8">Experiência</a>
        </li>
        <li>
          <a href="{{url}}plus500#section-9">Conselhos e dicas</a>
        </li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a href="#" id="drop" role="button" class="dropdown-toggle" data-toggle="dropdown"><img src="{{img-url}}flags/pt.png" class="flag"></a>
