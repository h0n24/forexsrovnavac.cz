...
"meta" : {
    "title": "Cisco Inc",
    "description": "Cisco Inc",
    "keywords": "Cisco Inc"
}
{{/settings}}

<h2>Cisco Inc - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NASDAQ:CSCO&ei=PQEBWPCMNYuFsAHm5YSYCA&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
