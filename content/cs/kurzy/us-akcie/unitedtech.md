...
"pageTitle": "United Technologies Corp",
"detail" : {
    "ticker": "NYSE:UTX",
    "burza": "US",
    "odvetvi": "ODVETVI"
...
"meta" : {
    ...
    "keywords": "United Technologies Corp"
}
{{/settings}}

<h2>United Technologies Corp - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NYSE:UTX&ei=dggBWMmvEobfsgHpi4XoAQ&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
