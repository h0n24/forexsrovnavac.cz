...
"meta" : {
    ...
    "keywords": "TESLA MOTORS INC"
}
{{/settings}}

<h2>TESLA MOTORS INC - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NASDAQ:TSLA&ei=9gcBWOnTOt2QswHKjLKwCA&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
