...
<h2>Procter & Gamble - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NYSE:PG&ei=5wYBWNHwM8GBsgGwjY8o&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
