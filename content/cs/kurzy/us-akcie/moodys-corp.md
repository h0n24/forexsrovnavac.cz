...
"meta" : {
    ...
    "keywords": "Moodys Corp"
}
{{/settings}}

<h2>Moodys Corp - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NYSE:MCO&ei=cgYBWNi7KIjisAGAxYOIAQ&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
