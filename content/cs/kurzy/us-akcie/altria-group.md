...
"meta" : {
    ...
    "keywords": "Altria Group"
}
{{/settings}}

<h2>Altria Group - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NYSE:MO&ei=Lf8AWMHYIYuFsAHm5YSYCA&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
