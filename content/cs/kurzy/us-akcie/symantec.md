...
"pageTitle": "Symantec Corporation",
"detail" : {
    "ticker": "NASDAQ:SYMC",
    "burza": "US",
    "odvetvi": "ODVETVI"
...
<h2>Symantec Corporation - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NASDAQ:SYMC&ei=6AcBWImeA4jisAGAxYOIAQ&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
