...
<h2>Harley Davidson - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NYSE:HOG&ei=4QQBWPHsFc3rsAGnw4fABg&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
