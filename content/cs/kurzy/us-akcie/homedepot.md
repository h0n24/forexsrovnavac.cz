...
"meta" : {
    ...
    "keywords": "Home Depot Inc"
}
{{/settings}}

<h2>Home Depot Inc - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NYSE:HD&ei=8wQBWJjUC9WssQH954SAAg&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
