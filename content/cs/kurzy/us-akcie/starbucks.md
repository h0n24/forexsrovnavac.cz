...
"meta" : {
    ...
    "keywords": "STARBUCKS CORP"
}
{{/settings}}

<h2>STARBUCKS CORP - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NASDAQ:SBUX&ei=2gcBWKjOJ4qHsgGDpIHACA&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
