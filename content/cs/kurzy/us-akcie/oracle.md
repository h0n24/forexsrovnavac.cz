...
"meta" : {
    ...
    "keywords": "Oracle Corp"
}
{{/settings}}

<h2>Oracle Corp - aktuální graf a vývoj ceny</h2>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="googleFeedContainer">
                    {{googleFeed url=>"https://www.google.com/finance/company_news?q=NYSE:ORCL&ei=2wYBWJnoLtWssQH954SAAg&output=rss"}}                    
                </div>
                <div class="clear"></div>
            </div>
