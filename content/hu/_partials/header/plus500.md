<header class="navbar navbar-fixed-top navbar-inverse" id="top" role="banner">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="{{url}}" class="navbar-brand">Forex <i class="fa fa-bar-chart-o"></i> földgyalu</a>
    </div>
    <nav class="navbar-collapse bs-navbar-collapse collapse" role="navigation" style="height: 1px;" id="scrollpsy">
      <ul class="nav navbar-nav">
        <li>
          <a href="{{url}}plus500#section-2">Üzletelés</a>
        </li>
        <li>
          <a href="{{url}}plus500#section-3">Hogyan üzletelhetünk</a>
        </li>
        <li>
          <a href="{{url}}plus500#section-5">Recenziója</a>
        </li>
        <li>
          <a href="{{url}}plus500#section-6">Használja</a>
        </li>
        <li class="hidden-sm hidden-md">
          <a href="{{url}}plus500#section-8">Tapasztalatok</a>
        </li>
        <li>
          <a href="{{url}}plus500#section-9"><span class="hidden-sm hidden-md">Tippek és tanácsok</span><span class="visible-sm visible-md">Tippek</a>
        </li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a href="#" id="drop" role="button" class="dropdown-toggle" data-toggle="dropdown"><img src="{{img-url}}flags/hu.png" class="flag"></a>
