...
![img]({{img-url}}hshare-hcash-logo.png)
  ...
  <div class="container">
    ...
    <nav class="navbar-collapse collapse" role="navigation" style="height: 1px;" id="scrollpsy">
      <ul class="nav navbar-nav">
        <li class="active">
          <a href="#top">Hshare cours (HSR) </a>
        </li>
        <li>
          <a href="#section-1">Hshare / Dollar</a>
        </li>
        <li>
          <a href="#section-1">Hshare / Euro</a>
        </li>
        <li>
          <a href="#section-1">Hshare / Bitcoin</a>
        </li>
