...
![img]({{img-url}}omisego-logo-crypto.png)
  ...
  <div class="container">
    ...
    <nav class="navbar-collapse collapse" role="navigation" style="height: 1px;" id="scrollpsy">
      <ul class="nav navbar-nav">
        <li class="active">
          <a href="#top">OmiseGO cours (OMG) </a>
        </li>
        <li>
          <a href="#section-1">OmiseGO / Dollar</a>
        </li>
        <li>
          <a href="#section-2">OmiseGO / Euro</a>
        </li>
        <li>
          <a href="#section-3">OmiseGO / Bitcoin</a>
        </li>
