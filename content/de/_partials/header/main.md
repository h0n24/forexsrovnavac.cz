      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
            <li role="presentation"><strong style="margin: 2px 0 0;padding: 5px 20px;color:blue; rgba(0, 0, 0, 0.3);"></strong></li>  
            <li role="presentation"><a role="menuitem" tabindex="-1" href="{{url}}bitcoin-trading">Bitcoin trading</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="{{url}}der-plus-500-webtrader-im-uberblick">Forex Webtrader</a></li>
...
<li><a href="{{url}}plus500/">Plus500</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="{{url}}ripple/">Ripple</a></li>
        <li class="dropdown">
